  ...
  return (
    <>
      ...
      <h2 className=" mt-4 block text-gray-700  mb-2 ">
        ...
        This selection includes three different types of aims, <span className="underline text-blue-400 hover:text-blue-500" onClick={()=>{router.push("documentation#citation2")}}>reported by Tondello, Premsukh, and Nacke, 2018</span>: <br/><bold className="font-bold">(1) Outcome goal</bold>, which refers to the accomplishment of a very specific result. For example, many goals involve completing specific tasks; 
